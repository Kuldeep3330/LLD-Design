...
class Database{
  ...
  saveToFile() {
    console.log("Your shopping cart purchase has been saved to the file")
  }

  saveToMySQL() {
    console.log("Your shopping cart purchase has been saved to the MySQL DB")
  }

  saveToMongoDb() {
    console.log("Your shopping cart purchase has been saved to MongoDB")
  }
}
