...
// now we have introduced another type of burger Garlic burger
class GarlicBread
{
public:
    virtual void prepare() = 0;
...
public:
    ...
    GarlicBread *createGarlicBread(string &type) override
    {
        ...
        {
            cout << "not preparing this type of garlic bread\n";
            return nullptr;
        }
    }
};
...
int main()
{
    ...
    GarlicBread *bread = myFactory->createGarlicBread(garlicBreadType);
